...
| **2026-05-19** | [`actions-cool` hijack](2026-05-actions-cool-hijack/) | Imposter commits via stolen maintainer creds, secrets scraped from `/proc/<pid>/mem` | `actions-cool/*` Actions | Prevention (source policy) ✅ + Content (secretscan) 🚧 + Behavior (`/proc/*/mem` access) 🚧 | 🚧 prevention live; content + behavior harness under debug |
